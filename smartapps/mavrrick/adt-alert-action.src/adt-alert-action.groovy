...
def mainPage()
{
	dynamicPage(name: "mainPage", title: "ADT Alert Action", uninstall: true, install: true)
	{
		...
		{
        	paragraph "Change the below value below value only if you want to use non dual branded sensors and use your this alert action in a unmonitored condition."       	
			input "alertTrgType", "bool", title: "Will all sensors be monitored by ADT", description: "Determines if using ADT dual branded sensors or generic sensors.", defaultValue: true, required: true, multiple: false
...
def adtTrigger()
{
	dynamicPage(name: "adtTrigger", title: "Alert Triggers to be used", uninstall: true, install: true)
	{
...
def adtActions()
{
	dynamicPage(name: "adtActions", title: "Alarm action", uninstall: true, install: true)
	{
		section()
		{
...
def adtLightsOpt()
{
	dynamicPage(name: "adtLightsOpt", title: "Optional Light Setup", uninstall: true, install: true)
	{
		section(){
...
def adtCameraSetup()
{
	dynamicPage(name: "adtCameraSetup", title: "Camera Setup", uninstall: true, install: true)
	{
